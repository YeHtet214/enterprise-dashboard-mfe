...
const moduleMap = {'react':{get:()=>()=>__federation_import(new URL('__federation_shared_react-BrALZ0a1.js', import.meta.url).href),import:true},'react-dom':{get:()=>()=>__federation_import(new URL('__federation_shared_react-dom-B-igiCQ4.js', import.meta.url).href),import:true},'react-router-dom':{get:()=>()=>__federation_import(new URL('__federation_shared_react-router-dom-CYSpGFF5.js', import.meta.url).href),import:true}};
